...
export { SmsChannel, RcsChannel, FacebookChannel, WhatsAppChannel, TextContent, FileContent, Template, PartialTemplate, LocationContent, ContactsContent, TemplateContent, MessageSubscription, MessageStatusSubscription, };
export declare type Channel = 'sms' | 'whatsapp' | 'facebook' | 'rcs';
export declare type ContentType = 'text' | 'file' | 'template' | 'contacts' | 'location' | 'json';
