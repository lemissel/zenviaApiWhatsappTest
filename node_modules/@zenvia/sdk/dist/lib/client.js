...
class Client {
    ...
    getChannel(channel) {
        switch (channel) {
            ...
            case 'rcs': return new rcs_1.RcsChannel(this.token, this.logger);
     ...
     */
    getFlowReportClient() {
        return new report_flow_1.ReportFlow(this.token, this.logger);
    }
    /**
    ...
    getMessagesReportClient() {
        return new report_messages_1.ReportMessages(this.token, this.logger);
    }
    /**
